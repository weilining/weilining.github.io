!function(p) {p.fn.circleMagic = function(t) {var o, a, n, r, e = !0, i = [], d = p.extend({color: "rgba(255,255,255,.5)",
            radius: 10,
            density: .3,
            clearOffset: .2
        }, t), l = this[0];
        ...
        function h() {if (e)
                for (var t in r.clearRect(0, 0, o, a),
                i)
                    i[t].draw();
        ...
        function f() {
            var t = this;
            function e() {t.pos.x = Math.random() * o,
            ...
            t.pos = {},
            e(),
            this.draw = function() {t.alpha <= 0 && e(),
                t.pos.y -= t.speed,
                t.alpha -= 5e-4,
                r.beginPath(),
